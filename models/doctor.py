...
class HospitalDoctor(models.Model):
    ...
    appointment_ids = fields.Many2many('hospital.appintment', 'hospital_appintment_hospital_doctor_rel',
                                       'hospital_doctor_id', 'hospital_appintment_id', string="Appointments")
